...
//*#  Memory Type    : TSMC 28nm High Performance Compact Mobile Computing Plus Ultra High Density Single Port SRAM with d127 bit cell SVT periphery */
//*# Library Name   : ts1n28hpcpuhdsvtb64x98m2sw (user specify : TS1N28HPCPUHDSVTB64X98M2SW)				*/
//*# Library Version: 170a												*/
//*# Generated Time : 2026/04/25, 09:59:31										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPUHDSVTB64X98M2SW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            RTSEL,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPUHDSVTB64X98M2SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPUHDSVTB64X98M2SW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.2464;
    specparam tCKH = 0.0498;
    specparam tCKL = 0.0694;
    specparam tCS = 0.0721;
    specparam tCH = 0.0672;
    specparam tWS = 0.0528;
    specparam tWH = 0.0672;
    specparam tAS = 0.0639;
    specparam tAH = 0.0671;
    specparam tDS = 0.0535;
    specparam tDH = 0.1295;
    specparam tCD = 0.2325;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2325;
`else    
    specparam tHOLD = 0.1762;
`endif    


    specparam tBWS = 0.0535;
    specparam tBWH = 0.1290;
    ...
    $setuphold(posedge CLK &&& check_write, negedge D[92], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[93], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[94], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[95], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[96], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[97], tDS, tDH, notify_din);
    ...
    $setuphold(posedge CLK &&& check_write, posedge D[92], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[93], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[94], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[95], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[96], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[97], tDS, tDH, notify_din);
    ...
    $setuphold(posedge CLK &&& check_write, negedge BWEB[92], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[93], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[94], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[95], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[96], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[97], tBWS, tBWH, notify_bweb);
    ...
    $setuphold(posedge CLK &&& check_write, posedge BWEB[92], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[93], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[94], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[95], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[96], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[97], tBWS, tBWH, notify_bweb);
...
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[92] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[92] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[92] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[93] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[93] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[93] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[94] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[94] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[94] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[95] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[95] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[95] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[96] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[96] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[96] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[97] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[97] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[97] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
...
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[92] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[92] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[92] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[93] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[93] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[93] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[94] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[94] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[94] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[95] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[95] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[95] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[96] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[96] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[96] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[97] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && D[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[97] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && D[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[97] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
...
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[92] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[93] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[94] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[95] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[96] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[97] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
...
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[92] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[92] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[93] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[93] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[94] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[94] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[95] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[95] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[96] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[96] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b0 && D[97] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input D[97] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
