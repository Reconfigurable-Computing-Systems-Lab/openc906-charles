...
//*# Library Name   : ts1n28hpcpuhdsvtb2048x32m4swso (user specify : TS1N28HPCPUHDSVTB2048X32M4SWSO)				*/
//*# Library Version: 170a												*/
//*# Generated Time : 2026/04/25, 09:58:57										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPUHDSVTB2048X32M4SWSO (
            SLP,
            SD,
            CLK, CEB, WEB,
            A, D,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPUHDSVTB2048X32M4SWSO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPUHDSVTB2048X32M4SWSO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.5484;
parameter tSLPQ = 0.4245;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.4522;
    specparam tCKH = 0.0638;
    specparam tCKL = 0.0898;
    specparam tCS = 0.1007;
    specparam tCH = 0.0618;
    specparam tWS = 0.1065;
    specparam tWH = 0.0637;
    specparam tAS = 0.1239;
    specparam tAH = 0.0595;
    specparam tDS = 0.0535;
    specparam tDH = 0.1018;
    specparam tCD = 0.4176;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.4176;
`else    
    specparam tHOLD = 0.3339;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 4.4167;
    specparam tSDWK2CLK = 4.4167;
    specparam tSD = 0.4522;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.1738;
    specparam tSDQ = 0.5484;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.4201;
    specparam tSLPWK2CLK = 0.4201;
    specparam tSLP = 0.4522;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.4244;
    specparam tSLPQ = 0.4245;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0535;
    specparam tBWH = 0.1025;
