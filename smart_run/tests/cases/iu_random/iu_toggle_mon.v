...
//   source    : ../C906_RTL_FACTORY/gen_rtl/iu/rtl/aq_iu_top.v
//   ports     : 118 total (115 functional, 3 infrastructure)
//
...
`define IU_MON_I tb.x_soc.x_cpu_sub_system_axi.x_c906_wrapper.x_cpu_top.x_aq_top_0.x_aq_core.x_aq_iu_top

module iu_toggle_mon (
  input clk,
  input rst_b
);
...
wire c0 = `IU_MON_I.cp0_iu_icg_en;
reg  p0;
reg  m0;
integer n0;
integer x0;
wire [39:0] c1 = `IU_MON_I.cp0_xx_mrvbr;
reg  [39:0] p1;
reg  [39:0] m1;
integer n1;
integer x1;
wire c2 = `IU_MON_I.cp0_yy_clk_en;
reg  p2;
reg  m2;
integer n2;
integer x2;
wire c3 = `IU_MON_I.cpurst_b;
reg  p3;
reg  m3;
integer n3;
integer x3;
wire [63:0] c4 = `IU_MON_I.da_xx_fwd_data;
reg  [63:0] p4;
reg  [63:0] m4;
integer n4;
integer x4;
wire [5:0] c5 = `IU_MON_I.da_xx_fwd_dst_reg;
reg  [5:0] p5;
reg  [5:0] m5;
integer n5;
integer x5;
wire c6 = `IU_MON_I.da_xx_fwd_vld;
reg  p6;
reg  m6;
integer n6;
integer x6;
wire c7 = `IU_MON_I.forever_cpuclk;
reg  p7;
reg  m7;
integer n7;
integer x7;
wire c8 = `IU_MON_I.hpcp_iu_cnt_en;
reg  p8;
reg  m8;
integer n8;
integer x8;
wire c9 = `IU_MON_I.idu_alu_ex1_gateclk_sel;
reg  p9;
reg  m9;
integer n9;
integer x9;
wire c10 = `IU_MON_I.idu_bju_ex1_gateclk_sel;
reg  p10;
reg  m10;
integer n10;
integer x10;
wire c11 = `IU_MON_I.idu_div_ex1_gateclk_sel;
reg  p11;
reg  m11;
integer n11;
integer x11;
wire c12 = `IU_MON_I.idu_iu_ex1_alu_dp_sel;
reg  p12;
reg  m12;
integer n12;
integer x12;
wire c13 = `IU_MON_I.idu_iu_ex1_alu_sel;
reg  p13;
reg  m13;
integer n13;
integer x13;
wire [1:0] c14 = `IU_MON_I.idu_iu_ex1_bht_pred;
reg  [1:0] p14;
reg  [1:0] m14;
integer n14;
integer x14;
wire c15 = `IU_MON_I.idu_iu_ex1_bju_br_sel;
reg  p15;
reg  m15;
integer n15;
integer x15;
wire c16 = `IU_MON_I.idu_iu_ex1_bju_dp_sel;
reg  p16;
reg  m16;
integer n16;
integer x16;
wire c17 = `IU_MON_I.idu_iu_ex1_bju_sel;
reg  p17;
reg  m17;
integer n17;
integer x17;
wire c18 = `IU_MON_I.idu_iu_ex1_div_dp_sel;
reg  p18;
reg  m18;
integer n18;
integer x18;
wire c19 = `IU_MON_I.idu_iu_ex1_div_sel;
reg  p19;
reg  m19;
integer n19;
integer x19;
wire [5:0] c20 = `IU_MON_I.idu_iu_ex1_dst0_reg;
reg  [5:0] p20;
reg  [5:0] m20;
integer n20;
integer x20;
wire [19:0] c21 = `IU_MON_I.idu_iu_ex1_func;
reg  [19:0] p21;
reg  [19:0] m21;
integer n21;
integer x21;
wire c22 = `IU_MON_I.idu_iu_ex1_inst_vld;
reg  p22;
reg  m22;
integer n22;
integer x22;
wire c23 = `IU_MON_I.idu_iu_ex1_length;
reg  p23;
reg  m23;
integer n23;
integer x23;
wire c24 = `IU_MON_I.idu_iu_ex1_mult_dp_sel;
reg  p24;
reg  m24;
integer n24;
integer x24;
wire c25 = `IU_MON_I.idu_iu_ex1_mult_sel;
reg  p25;
reg  m25;
integer n25;
integer x25;
wire c26 = `IU_MON_I.idu_iu_ex1_pipedown_vld;
reg  p26;
reg  m26;
integer n26;
integer x26;
wire c27 = `IU_MON_I.idu_iu_ex1_split;
reg  p27;
reg  m27;
integer n27;
integer x27;
wire [63:0] c28 = `IU_MON_I.idu_iu_ex1_src0_data;
reg  [63:0] p28;
reg  [63:0] m28;
integer n28;
integer x28;
wire c29 = `IU_MON_I.idu_iu_ex1_src0_ready;
reg  p29;
reg  m29;
integer n29;
integer x29;
wire [5:0] c30 = `IU_MON_I.idu_iu_ex1_src0_reg;
reg  [5:0] p30;
reg  [5:0] m30;
integer n30;
integer x30;
wire [63:0] c31 = `IU_MON_I.idu_iu_ex1_src1_data;
reg  [63:0] p31;
reg  [63:0] m31;
integer n31;
integer x31;
wire c32 = `IU_MON_I.idu_iu_ex1_src1_ready;
reg  p32;
reg  m32;
integer n32;
integer x32;
wire [5:0] c33 = `IU_MON_I.idu_iu_ex1_src1_reg;
reg  [5:0] p33;
reg  [5:0] m33;
integer n33;
integer x33;
wire [63:0] c34 = `IU_MON_I.idu_iu_ex1_src2_data;
reg  [63:0] p34;
reg  [63:0] m34;
integer n34;
integer x34;
wire c35 = `IU_MON_I.idu_mult_ex1_gateclk_sel;
reg  p35;
reg  m35;
integer n35;
integer x35;
wire [39:0] c36 = `IU_MON_I.ifu_iu_chgflw_pc;
reg  [39:0] p36;
reg  [39:0] m36;
integer n36;
integer x36;
wire c37 = `IU_MON_I.ifu_iu_chgflw_vld;
reg  p37;
reg  m37;
integer n37;
integer x37;
wire [39:0] c38 = `IU_MON_I.ifu_iu_ex1_pc_pred;
reg  [39:0] p38;
reg  [39:0] m38;
integer n38;
integer x38;
wire c39 = `IU_MON_I.ifu_iu_reset_vld;
reg  p39;
reg  m39;
integer n39;
integer x39;
wire c40 = `IU_MON_I.ifu_iu_warm_up;
reg  p40;
reg  m40;
integer n40;
integer x40;
wire [63:0] c41 = `IU_MON_I.lsu_iu_ex2_data;
reg  [63:0] p41;
reg  [63:0] m41;
integer n41;
integer x41;
wire c42 = `IU_MON_I.lsu_iu_ex2_data_vld;
reg  p42;
reg  m42;
integer n42;
integer x42;
wire [4:0] c43 = `IU_MON_I.lsu_iu_ex2_dest_reg;
reg  [4:0] p43;
reg  [4:0] m43;
integer n43;
integer x43;
wire c44 = `IU_MON_I.mmu_xx_mmu_en;
reg  p44;
reg  m44;
integer n44;
integer x44;
wire c45 = `IU_MON_I.pad_yy_icg_scan_en;
reg  p45;
reg  m45;
integer n45;
integer x45;
wire c46 = `IU_MON_I.rtu_iu_div_wb_grant;
reg  p46;
reg  m46;
integer n46;
integer x46;
wire c47 = `IU_MON_I.rtu_iu_div_wb_grant_for_full;
reg  p47;
reg  m47;
integer n47;
integer x47;
wire c48 = `IU_MON_I.rtu_iu_ex1_cmplt;
reg  p48;
reg  m48;
integer n48;
integer x48;
wire c49 = `IU_MON_I.rtu_iu_ex1_cmplt_dp;
reg  p49;
reg  m49;
integer n49;
integer x49;
wire c50 = `IU_MON_I.rtu_iu_ex1_inst_len;
reg  p50;
reg  m50;
integer n50;
integer x50;
wire c51 = `IU_MON_I.rtu_iu_ex1_inst_split;
reg  p51;
reg  m51;
integer n51;
integer x51;
wire [39:0] c52 = `IU_MON_I.rtu_iu_ex2_cur_pc;
reg  [39:0] p52;
reg  [39:0] m52;
integer n52;
integer x52;
wire [39:0] c53 = `IU_MON_I.rtu_iu_ex2_next_pc;
reg  [39:0] p53;
reg  [39:0] m53;
integer n53;
integer x53;
wire c54 = `IU_MON_I.rtu_iu_mul_wb_grant;
reg  p54;
reg  m54;
integer n54;
integer x54;
wire c55 = `IU_MON_I.rtu_iu_mul_wb_grant_for_full;
reg  p55;
reg  m55;
integer n55;
integer x55;
wire c56 = `IU_MON_I.rtu_yy_xx_flush_fe;
reg  p56;
reg  m56;
integer n56;
integer x56;
wire [39:0] c57 = `IU_MON_I.iu_cp0_ex1_cur_pc;
reg  [39:0] p57;
reg  [39:0] m57;
integer n57;
integer x57;
wire [8:0] c58 = `IU_MON_I.iu_dtu_debug_info;
reg  [8:0] p58;
reg  [8:0] m58;
integer n58;
integer x58;
wire c59 = `IU_MON_I.iu_hpcp_inst_bht_mispred;
reg  p59;
reg  m59;
integer n59;
integer x59;
wire c60 = `IU_MON_I.iu_hpcp_inst_condbr;
reg  p60;
reg  m60;
integer n60;
integer x60;
wire c61 = `IU_MON_I.iu_hpcp_jump_8m;
reg  p61;
reg  m61;
integer n61;
integer x61;
wire c62 = `IU_MON_I.iu_idu_bju_full;
reg  p62;
reg  m62;
integer n62;
integer x62;
wire c63 = `IU_MON_I.iu_idu_bju_global_full;
reg  p63;
reg  m63;
integer n63;
integer x63;
wire c64 = `IU_MON_I.iu_idu_div_full;
reg  p64;
reg  m64;
integer n64;
integer x64;
wire c65 = `IU_MON_I.iu_idu_mult_full;
reg  p65;
reg  m65;
integer n65;
integer x65;
wire c66 = `IU_MON_I.iu_idu_mult_issue_stall;
reg  p66;
reg  m66;
integer n66;
integer x66;
wire [39:0] c67 = `IU_MON_I.iu_ifu_bht_cur_pc;
reg  [39:0] p67;
reg  [39:0] m67;
integer n67;
integer x67;
wire c68 = `IU_MON_I.iu_ifu_bht_mispred;
reg  p68;
reg  m68;
integer n68;
integer x68;
wire c69 = `IU_MON_I.iu_ifu_bht_mispred_gate;
reg  p69;
reg  m69;
integer n69;
integer x69;
wire [1:0] c70 = `IU_MON_I.iu_ifu_bht_pred;
reg  [1:0] p70;
reg  [1:0] m70;
integer n70;
integer x70;
wire c71 = `IU_MON_I.iu_ifu_bht_taken;
reg  p71;
reg  m71;
integer n71;
integer x71;
wire c72 = `IU_MON_I.iu_ifu_br_vld;
reg  p72;
reg  m72;
integer n72;
integer x72;
wire c73 = `IU_MON_I.iu_ifu_br_vld_gate;
reg  p73;
reg  m73;
integer n73;
integer x73;
wire c74 = `IU_MON_I.iu_ifu_link_vld;
reg  p74;
reg  m74;
integer n74;
integer x74;
wire c75 = `IU_MON_I.iu_ifu_link_vld_gate;
reg  p75;
reg  m75;
integer n75;
integer x75;
wire c76 = `IU_MON_I.iu_ifu_pc_mispred;
reg  p76;
reg  m76;
integer n76;
integer x76;
wire c77 = `IU_MON_I.iu_ifu_pc_mispred_gate;
reg  p77;
reg  m77;
integer n77;
integer x77;
wire c78 = `IU_MON_I.iu_ifu_ret_vld;
reg  p78;
reg  m78;
integer n78;
integer x78;
wire c79 = `IU_MON_I.iu_ifu_ret_vld_gate;
reg  p79;
reg  m79;
integer n79;
integer x79;
wire [63:0] c80 = `IU_MON_I.iu_ifu_tar_pc;
reg  [63:0] p80;
reg  [63:0] m80;
integer n80;
integer x80;
wire c81 = `IU_MON_I.iu_ifu_tar_pc_vld;
reg  p81;
reg  m81;
integer n81;
integer x81;
wire c82 = `IU_MON_I.iu_ifu_tar_pc_vld_gate;
reg  p82;
reg  m82;
integer n82;
integer x82;
wire [15:0] c83 = `IU_MON_I.iu_lsu_ex1_cur_pc;
reg  [15:0] p83;
reg  [15:0] m83;
integer n83;
integer x83;
wire c84 = `IU_MON_I.iu_rtu_depd_lsu_chgflow_vld;
reg  p84;
reg  m84;
integer n84;
integer x84;
wire [39:0] c85 = `IU_MON_I.iu_rtu_depd_lsu_next_pc;
reg  [39:0] p85;
reg  [39:0] m85;
integer n85;
integer x85;
wire [63:0] c86 = `IU_MON_I.iu_rtu_div_data;
reg  [63:0] p86;
reg  [63:0] m86;
integer n86;
integer x86;
wire [5:0] c87 = `IU_MON_I.iu_rtu_div_preg;
reg  [5:0] p87;
reg  [5:0] m87;
integer n87;
integer x87;
wire c88 = `IU_MON_I.iu_rtu_div_wb_dp;
reg  p88;
reg  m88;
integer n88;
integer x88;
wire c89 = `IU_MON_I.iu_rtu_div_wb_vld;
reg  p89;
reg  m89;
integer n89;
integer x89;
wire c90 = `IU_MON_I.iu_rtu_ex1_alu_cmplt;
reg  p90;
reg  m90;
integer n90;
integer x90;
wire c91 = `IU_MON_I.iu_rtu_ex1_alu_cmplt_dp;
reg  p91;
reg  m91;
integer n91;
integer x91;
wire [63:0] c92 = `IU_MON_I.iu_rtu_ex1_alu_data;
reg  [63:0] p92;
reg  [63:0] m92;
integer n92;
integer x92;
wire c93 = `IU_MON_I.iu_rtu_ex1_alu_inst_len;
reg  p93;
reg  m93;
integer n93;
integer x93;
wire c94 = `IU_MON_I.iu_rtu_ex1_alu_inst_split;
reg  p94;
reg  m94;
integer n94;
integer x94;
wire [5:0] c95 = `IU_MON_I.iu_rtu_ex1_alu_preg;
reg  [5:0] p95;
reg  [5:0] m95;
integer n95;
integer x95;
wire c96 = `IU_MON_I.iu_rtu_ex1_alu_wb_dp;
reg  p96;
reg  m96;
integer n96;
integer x96;
wire c97 = `IU_MON_I.iu_rtu_ex1_alu_wb_vld;
reg  p97;
reg  m97;
integer n97;
integer x97;
wire c98 = `IU_MON_I.iu_rtu_ex1_bju_cmplt;
reg  p98;
reg  m98;
integer n98;
integer x98;
wire c99 = `IU_MON_I.iu_rtu_ex1_bju_cmplt_dp;
reg  p99;
reg  m99;
integer n99;
integer x99;
wire [63:0] c100 = `IU_MON_I.iu_rtu_ex1_bju_data;
reg  [63:0] p100;
reg  [63:0] m100;
integer n100;
integer x100;
wire c101 = `IU_MON_I.iu_rtu_ex1_bju_inst_len;
reg  p101;
reg  m101;
integer n101;
integer x101;
wire [5:0] c102 = `IU_MON_I.iu_rtu_ex1_bju_preg;
reg  [5:0] p102;
reg  [5:0] m102;
integer n102;
integer x102;
wire c103 = `IU_MON_I.iu_rtu_ex1_bju_wb_dp;
reg  p103;
reg  m103;
integer n103;
integer x103;
wire c104 = `IU_MON_I.iu_rtu_ex1_bju_wb_vld;
reg  p104;
reg  m104;
integer n104;
integer x104;
wire c105 = `IU_MON_I.iu_rtu_ex1_branch_inst;
reg  p105;
reg  m105;
integer n105;
integer x105;
wire [39:0] c106 = `IU_MON_I.iu_rtu_ex1_cur_pc;
reg  [39:0] p106;
reg  [39:0] m106;
integer n106;
integer x106;
wire c107 = `IU_MON_I.iu_rtu_ex1_div_cmplt;
reg  p107;
reg  m107;
integer n107;
integer x107;
wire c108 = `IU_MON_I.iu_rtu_ex1_div_cmplt_dp;
reg  p108;
reg  m108;
integer n108;
integer x108;
wire c109 = `IU_MON_I.iu_rtu_ex1_mul_cmplt;
reg  p109;
reg  m109;
integer n109;
integer x109;
wire c110 = `IU_MON_I.iu_rtu_ex1_mul_cmplt_dp;
reg  p110;
reg  m110;
integer n110;
integer x110;
wire [39:0] c111 = `IU_MON_I.iu_rtu_ex1_next_pc;
reg  [39:0] p111;
reg  [39:0] m111;
integer n111;
integer x111;
wire c112 = `IU_MON_I.iu_rtu_ex2_bju_ras_mispred;
reg  p112;
reg  m112;
integer n112;
integer x112;
wire [63:0] c113 = `IU_MON_I.iu_rtu_ex3_mul_data;
reg  [63:0] p113;
reg  [63:0] m113;
integer n113;
integer x113;
wire [5:0] c114 = `IU_MON_I.iu_rtu_ex3_mul_preg;
reg  [5:0] p114;
reg  [5:0] m114;
integer n114;
integer x114;
wire c115 = `IU_MON_I.iu_rtu_ex3_mul_wb_vld;
reg  p115;
reg  m115;
integer n115;
integer x115;
wire c116 = `IU_MON_I.iu_xx_no_op;
reg  p116;
reg  m116;
integer n116;
integer x116;
wire c117 = `IU_MON_I.iu_yy_xx_cancel;
reg  p117;
reg  m117;
integer n117;
integer x117;
...
final begin
  FH = $fopen("iu_toggle.report", "w");
  $fwrite(FH, "IU port toggle report -- instance:\n");
  $fwrite(FH, "  tb.x_soc.x_cpu_sub_system_axi.x_c906_wrapper.x_cpu_top.x_aq_top_0.x_aq_core.x_aq_iu_top\n\n");
  $fwrite(FH, "port                               dir  width  bits_tog  tog_events  x_cycles\n");
  $fwrite(FH, "----------------------------------------------------------------------------\n");
  n_tog = 0;
  n_xseen = 0;
  $fwrite(FH, "cp0_iu_icg_en                      in      1 %0d %0d %0d\n", ones({63'b0, m0}), n0, x0);
  if (|m0) n_tog = n_tog + 1;
  ...
  $fwrite(FH, "da_xx_fwd_data                     in     64 %0d %0d %0d\n", ones({m4}), n4, x4);
  if (|m4) n_tog = n_tog + 1;
  if (x4 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "da_xx_fwd_dst_reg                  in      6 %0d %0d %0d\n", ones({58'b0, m5}), n5, x5);
  if (|m5) n_tog = n_tog + 1;
  if (x5 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "da_xx_fwd_vld                      in      1 %0d %0d %0d\n", ones({63'b0, m6}), n6, x6);
  if (|m6) n_tog = n_tog + 1;
  if (x6 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "forever_cpuclk                     in      1 %0d %0d %0d   [infra]\n", ones({63'b0, m7}), n7, x7);
  $fwrite(FH, "hpcp_iu_cnt_en                     in      1 %0d %0d %0d\n", ones({63'b0, m8}), n8, x8);
  if (|m8) n_tog = n_tog + 1;
  if (x8 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_alu_ex1_gateclk_sel            in      1 %0d %0d %0d\n", ones({63'b0, m9}), n9, x9);
  if (|m9) n_tog = n_tog + 1;
  if (x9 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_bju_ex1_gateclk_sel            in      1 %0d %0d %0d\n", ones({63'b0, m10}), n10, x10);
  if (|m10) n_tog = n_tog + 1;
  if (x10 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_div_ex1_gateclk_sel            in      1 %0d %0d %0d\n", ones({63'b0, m11}), n11, x11);
  if (|m11) n_tog = n_tog + 1;
  if (x11 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_alu_dp_sel              in      1 %0d %0d %0d\n", ones({63'b0, m12}), n12, x12);
  if (|m12) n_tog = n_tog + 1;
  if (x12 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_alu_sel                 in      1 %0d %0d %0d\n", ones({63'b0, m13}), n13, x13);
  if (|m13) n_tog = n_tog + 1;
  if (x13 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_bht_pred                in      2 %0d %0d %0d\n", ones({62'b0, m14}), n14, x14);
  if (|m14) n_tog = n_tog + 1;
  if (x14 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_bju_br_sel              in      1 %0d %0d %0d\n", ones({63'b0, m15}), n15, x15);
  if (|m15) n_tog = n_tog + 1;
  if (x15 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_bju_dp_sel              in      1 %0d %0d %0d\n", ones({63'b0, m16}), n16, x16);
  if (|m16) n_tog = n_tog + 1;
  if (x16 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_bju_sel                 in      1 %0d %0d %0d\n", ones({63'b0, m17}), n17, x17);
  if (|m17) n_tog = n_tog + 1;
  if (x17 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_div_dp_sel              in      1 %0d %0d %0d\n", ones({63'b0, m18}), n18, x18);
  if (|m18) n_tog = n_tog + 1;
  if (x18 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_div_sel                 in      1 %0d %0d %0d\n", ones({63'b0, m19}), n19, x19);
  if (|m19) n_tog = n_tog + 1;
  if (x19 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_dst0_reg                in      6 %0d %0d %0d\n", ones({58'b0, m20}), n20, x20);
  if (|m20) n_tog = n_tog + 1;
  if (x20 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_func                    in     20 %0d %0d %0d\n", ones({44'b0, m21}), n21, x21);
  if (|m21) n_tog = n_tog + 1;
  if (x21 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_inst_vld                in      1 %0d %0d %0d\n", ones({63'b0, m22}), n22, x22);
  if (|m22) n_tog = n_tog + 1;
  if (x22 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_length                  in      1 %0d %0d %0d\n", ones({63'b0, m23}), n23, x23);
  if (|m23) n_tog = n_tog + 1;
  if (x23 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_mult_dp_sel             in      1 %0d %0d %0d\n", ones({63'b0, m24}), n24, x24);
  if (|m24) n_tog = n_tog + 1;
  if (x24 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_mult_sel                in      1 %0d %0d %0d\n", ones({63'b0, m25}), n25, x25);
  if (|m25) n_tog = n_tog + 1;
  if (x25 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_pipedown_vld            in      1 %0d %0d %0d\n", ones({63'b0, m26}), n26, x26);
  if (|m26) n_tog = n_tog + 1;
  if (x26 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_split                   in      1 %0d %0d %0d\n", ones({63'b0, m27}), n27, x27);
  if (|m27) n_tog = n_tog + 1;
  if (x27 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src0_data               in     64 %0d %0d %0d\n", ones({m28}), n28, x28);
  if (|m28) n_tog = n_tog + 1;
  if (x28 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src0_ready              in      1 %0d %0d %0d\n", ones({63'b0, m29}), n29, x29);
  if (|m29) n_tog = n_tog + 1;
  if (x29 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src0_reg                in      6 %0d %0d %0d\n", ones({58'b0, m30}), n30, x30);
  if (|m30) n_tog = n_tog + 1;
  if (x30 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src1_data               in     64 %0d %0d %0d\n", ones({m31}), n31, x31);
  if (|m31) n_tog = n_tog + 1;
  if (x31 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src1_ready              in      1 %0d %0d %0d\n", ones({63'b0, m32}), n32, x32);
  if (|m32) n_tog = n_tog + 1;
  if (x32 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src1_reg                in      6 %0d %0d %0d\n", ones({58'b0, m33}), n33, x33);
  if (|m33) n_tog = n_tog + 1;
  if (x33 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_iu_ex1_src2_data               in     64 %0d %0d %0d\n", ones({m34}), n34, x34);
  if (|m34) n_tog = n_tog + 1;
  if (x34 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "idu_mult_ex1_gateclk_sel           in      1 %0d %0d %0d\n", ones({63'b0, m35}), n35, x35);
  if (|m35) n_tog = n_tog + 1;
  if (x35 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "ifu_iu_chgflw_pc                   in     40 %0d %0d %0d\n", ones({24'b0, m36}), n36, x36);
  if (|m36) n_tog = n_tog + 1;
  if (x36 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "ifu_iu_chgflw_vld                  in      1 %0d %0d %0d\n", ones({63'b0, m37}), n37, x37);
  if (|m37) n_tog = n_tog + 1;
  if (x37 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "ifu_iu_ex1_pc_pred                 in     40 %0d %0d %0d\n", ones({24'b0, m38}), n38, x38);
  if (|m38) n_tog = n_tog + 1;
  if (x38 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "ifu_iu_reset_vld                   in      1 %0d %0d %0d\n", ones({63'b0, m39}), n39, x39);
  if (|m39) n_tog = n_tog + 1;
  if (x39 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "ifu_iu_warm_up                     in      1 %0d %0d %0d\n", ones({63'b0, m40}), n40, x40);
  if (|m40) n_tog = n_tog + 1;
  if (x40 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "lsu_iu_ex2_data                    in     64 %0d %0d %0d\n", ones({m41}), n41, x41);
  if (|m41) n_tog = n_tog + 1;
  if (x41 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "lsu_iu_ex2_data_vld                in      1 %0d %0d %0d\n", ones({63'b0, m42}), n42, x42);
  if (|m42) n_tog = n_tog + 1;
  if (x42 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "lsu_iu_ex2_dest_reg                in      5 %0d %0d %0d\n", ones({59'b0, m43}), n43, x43);
  if (|m43) n_tog = n_tog + 1;
  if (x43 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "mmu_xx_mmu_en                      in      1 %0d %0d %0d\n", ones({63'b0, m44}), n44, x44);
  if (|m44) n_tog = n_tog + 1;
  if (x44 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "pad_yy_icg_scan_en                 in      1 %0d %0d %0d   [infra]\n", ones({63'b0, m45}), n45, x45);
  $fwrite(FH, "rtu_iu_div_wb_grant                in      1 %0d %0d %0d\n", ones({63'b0, m46}), n46, x46);
  if (|m46) n_tog = n_tog + 1;
  if (x46 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_div_wb_grant_for_full       in      1 %0d %0d %0d\n", ones({63'b0, m47}), n47, x47);
  if (|m47) n_tog = n_tog + 1;
  if (x47 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex1_cmplt                   in      1 %0d %0d %0d\n", ones({63'b0, m48}), n48, x48);
  if (|m48) n_tog = n_tog + 1;
  if (x48 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex1_cmplt_dp                in      1 %0d %0d %0d\n", ones({63'b0, m49}), n49, x49);
  if (|m49) n_tog = n_tog + 1;
  if (x49 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex1_inst_len                in      1 %0d %0d %0d\n", ones({63'b0, m50}), n50, x50);
  if (|m50) n_tog = n_tog + 1;
  if (x50 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex1_inst_split              in      1 %0d %0d %0d\n", ones({63'b0, m51}), n51, x51);
  if (|m51) n_tog = n_tog + 1;
  if (x51 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex2_cur_pc                  in     40 %0d %0d %0d\n", ones({24'b0, m52}), n52, x52);
  if (|m52) n_tog = n_tog + 1;
  if (x52 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_ex2_next_pc                 in     40 %0d %0d %0d\n", ones({24'b0, m53}), n53, x53);
  if (|m53) n_tog = n_tog + 1;
  if (x53 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_mul_wb_grant                in      1 %0d %0d %0d\n", ones({63'b0, m54}), n54, x54);
  if (|m54) n_tog = n_tog + 1;
  if (x54 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_iu_mul_wb_grant_for_full       in      1 %0d %0d %0d\n", ones({63'b0, m55}), n55, x55);
  if (|m55) n_tog = n_tog + 1;
  if (x55 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "rtu_yy_xx_flush_fe                 in      1 %0d %0d %0d\n", ones({63'b0, m56}), n56, x56);
  if (|m56) n_tog = n_tog + 1;
  if (x56 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_cp0_ex1_cur_pc                  out    40 %0d %0d %0d\n", ones({24'b0, m57}), n57, x57);
  if (|m57) n_tog = n_tog + 1;
  if (x57 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_dtu_debug_info                  out     9 %0d %0d %0d\n", ones({55'b0, m58}), n58, x58);
  if (|m58) n_tog = n_tog + 1;
  if (x58 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_hpcp_inst_bht_mispred           out     1 %0d %0d %0d\n", ones({63'b0, m59}), n59, x59);
  if (|m59) n_tog = n_tog + 1;
  if (x59 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_hpcp_inst_condbr                out     1 %0d %0d %0d\n", ones({63'b0, m60}), n60, x60);
  if (|m60) n_tog = n_tog + 1;
  if (x60 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_hpcp_jump_8m                    out     1 %0d %0d %0d\n", ones({63'b0, m61}), n61, x61);
  if (|m61) n_tog = n_tog + 1;
  if (x61 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_idu_bju_full                    out     1 %0d %0d %0d\n", ones({63'b0, m62}), n62, x62);
  if (|m62) n_tog = n_tog + 1;
  if (x62 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_idu_bju_global_full             out     1 %0d %0d %0d\n", ones({63'b0, m63}), n63, x63);
  if (|m63) n_tog = n_tog + 1;
  if (x63 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_idu_div_full                    out     1 %0d %0d %0d\n", ones({63'b0, m64}), n64, x64);
  if (|m64) n_tog = n_tog + 1;
  if (x64 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_idu_mult_full                   out     1 %0d %0d %0d\n", ones({63'b0, m65}), n65, x65);
  if (|m65) n_tog = n_tog + 1;
  if (x65 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_idu_mult_issue_stall            out     1 %0d %0d %0d\n", ones({63'b0, m66}), n66, x66);
  if (|m66) n_tog = n_tog + 1;
  if (x66 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_bht_cur_pc                  out    40 %0d %0d %0d\n", ones({24'b0, m67}), n67, x67);
  if (|m67) n_tog = n_tog + 1;
  if (x67 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_bht_mispred                 out     1 %0d %0d %0d\n", ones({63'b0, m68}), n68, x68);
  if (|m68) n_tog = n_tog + 1;
  if (x68 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_bht_mispred_gate            out     1 %0d %0d %0d\n", ones({63'b0, m69}), n69, x69);
  if (|m69) n_tog = n_tog + 1;
  if (x69 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_bht_pred                    out     2 %0d %0d %0d\n", ones({62'b0, m70}), n70, x70);
  if (|m70) n_tog = n_tog + 1;
  if (x70 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_bht_taken                   out     1 %0d %0d %0d\n", ones({63'b0, m71}), n71, x71);
  if (|m71) n_tog = n_tog + 1;
  if (x71 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_br_vld                      out     1 %0d %0d %0d\n", ones({63'b0, m72}), n72, x72);
  if (|m72) n_tog = n_tog + 1;
  if (x72 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_br_vld_gate                 out     1 %0d %0d %0d\n", ones({63'b0, m73}), n73, x73);
  if (|m73) n_tog = n_tog + 1;
  if (x73 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_link_vld                    out     1 %0d %0d %0d\n", ones({63'b0, m74}), n74, x74);
  if (|m74) n_tog = n_tog + 1;
  if (x74 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_link_vld_gate               out     1 %0d %0d %0d\n", ones({63'b0, m75}), n75, x75);
  if (|m75) n_tog = n_tog + 1;
  if (x75 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_pc_mispred                  out     1 %0d %0d %0d\n", ones({63'b0, m76}), n76, x76);
  if (|m76) n_tog = n_tog + 1;
  if (x76 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_pc_mispred_gate             out     1 %0d %0d %0d\n", ones({63'b0, m77}), n77, x77);
  if (|m77) n_tog = n_tog + 1;
  if (x77 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_ret_vld                     out     1 %0d %0d %0d\n", ones({63'b0, m78}), n78, x78);
  if (|m78) n_tog = n_tog + 1;
  if (x78 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_ret_vld_gate                out     1 %0d %0d %0d\n", ones({63'b0, m79}), n79, x79);
  if (|m79) n_tog = n_tog + 1;
  if (x79 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_tar_pc                      out    64 %0d %0d %0d\n", ones({m80}), n80, x80);
  if (|m80) n_tog = n_tog + 1;
  if (x80 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_tar_pc_vld                  out     1 %0d %0d %0d\n", ones({63'b0, m81}), n81, x81);
  if (|m81) n_tog = n_tog + 1;
  if (x81 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_ifu_tar_pc_vld_gate             out     1 %0d %0d %0d\n", ones({63'b0, m82}), n82, x82);
  if (|m82) n_tog = n_tog + 1;
  if (x82 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_lsu_ex1_cur_pc                  out    16 %0d %0d %0d\n", ones({48'b0, m83}), n83, x83);
  if (|m83) n_tog = n_tog + 1;
  if (x83 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_depd_lsu_chgflow_vld        out     1 %0d %0d %0d\n", ones({63'b0, m84}), n84, x84);
  if (|m84) n_tog = n_tog + 1;
  if (x84 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_depd_lsu_next_pc            out    40 %0d %0d %0d\n", ones({24'b0, m85}), n85, x85);
  if (|m85) n_tog = n_tog + 1;
  if (x85 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_div_data                    out    64 %0d %0d %0d\n", ones({m86}), n86, x86);
  if (|m86) n_tog = n_tog + 1;
  if (x86 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_div_preg                    out     6 %0d %0d %0d\n", ones({58'b0, m87}), n87, x87);
  if (|m87) n_tog = n_tog + 1;
  if (x87 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_div_wb_dp                   out     1 %0d %0d %0d\n", ones({63'b0, m88}), n88, x88);
  if (|m88) n_tog = n_tog + 1;
  if (x88 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_div_wb_vld                  out     1 %0d %0d %0d\n", ones({63'b0, m89}), n89, x89);
  if (|m89) n_tog = n_tog + 1;
  if (x89 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_cmplt               out     1 %0d %0d %0d\n", ones({63'b0, m90}), n90, x90);
  if (|m90) n_tog = n_tog + 1;
  if (x90 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_cmplt_dp            out     1 %0d %0d %0d\n", ones({63'b0, m91}), n91, x91);
  if (|m91) n_tog = n_tog + 1;
  if (x91 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_data                out    64 %0d %0d %0d\n", ones({m92}), n92, x92);
  if (|m92) n_tog = n_tog + 1;
  if (x92 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_inst_len            out     1 %0d %0d %0d\n", ones({63'b0, m93}), n93, x93);
  if (|m93) n_tog = n_tog + 1;
  if (x93 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_inst_split          out     1 %0d %0d %0d\n", ones({63'b0, m94}), n94, x94);
  if (|m94) n_tog = n_tog + 1;
  if (x94 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_preg                out     6 %0d %0d %0d\n", ones({58'b0, m95}), n95, x95);
  if (|m95) n_tog = n_tog + 1;
  if (x95 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_wb_dp               out     1 %0d %0d %0d\n", ones({63'b0, m96}), n96, x96);
  if (|m96) n_tog = n_tog + 1;
  if (x96 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_alu_wb_vld              out     1 %0d %0d %0d\n", ones({63'b0, m97}), n97, x97);
  if (|m97) n_tog = n_tog + 1;
  if (x97 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_cmplt               out     1 %0d %0d %0d\n", ones({63'b0, m98}), n98, x98);
  if (|m98) n_tog = n_tog + 1;
  if (x98 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_cmplt_dp            out     1 %0d %0d %0d\n", ones({63'b0, m99}), n99, x99);
  if (|m99) n_tog = n_tog + 1;
  if (x99 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_data                out    64 %0d %0d %0d\n", ones({m100}), n100, x100);
  if (|m100) n_tog = n_tog + 1;
  if (x100 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_inst_len            out     1 %0d %0d %0d\n", ones({63'b0, m101}), n101, x101);
  if (|m101) n_tog = n_tog + 1;
  if (x101 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_preg                out     6 %0d %0d %0d\n", ones({58'b0, m102}), n102, x102);
  if (|m102) n_tog = n_tog + 1;
  if (x102 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_wb_dp               out     1 %0d %0d %0d\n", ones({63'b0, m103}), n103, x103);
  if (|m103) n_tog = n_tog + 1;
  if (x103 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_bju_wb_vld              out     1 %0d %0d %0d\n", ones({63'b0, m104}), n104, x104);
  if (|m104) n_tog = n_tog + 1;
  if (x104 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_branch_inst             out     1 %0d %0d %0d\n", ones({63'b0, m105}), n105, x105);
  if (|m105) n_tog = n_tog + 1;
  if (x105 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_cur_pc                  out    40 %0d %0d %0d\n", ones({24'b0, m106}), n106, x106);
  if (|m106) n_tog = n_tog + 1;
  if (x106 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_div_cmplt               out     1 %0d %0d %0d\n", ones({63'b0, m107}), n107, x107);
  if (|m107) n_tog = n_tog + 1;
  if (x107 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_div_cmplt_dp            out     1 %0d %0d %0d\n", ones({63'b0, m108}), n108, x108);
  if (|m108) n_tog = n_tog + 1;
  if (x108 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_mul_cmplt               out     1 %0d %0d %0d\n", ones({63'b0, m109}), n109, x109);
  if (|m109) n_tog = n_tog + 1;
  if (x109 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_mul_cmplt_dp            out     1 %0d %0d %0d\n", ones({63'b0, m110}), n110, x110);
  if (|m110) n_tog = n_tog + 1;
  if (x110 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex1_next_pc                 out    40 %0d %0d %0d\n", ones({24'b0, m111}), n111, x111);
  if (|m111) n_tog = n_tog + 1;
  if (x111 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex2_bju_ras_mispred         out     1 %0d %0d %0d\n", ones({63'b0, m112}), n112, x112);
  if (|m112) n_tog = n_tog + 1;
  if (x112 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex3_mul_data                out    64 %0d %0d %0d\n", ones({m113}), n113, x113);
  if (|m113) n_tog = n_tog + 1;
  if (x113 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex3_mul_preg                out     6 %0d %0d %0d\n", ones({58'b0, m114}), n114, x114);
  if (|m114) n_tog = n_tog + 1;
  if (x114 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_rtu_ex3_mul_wb_vld              out     1 %0d %0d %0d\n", ones({63'b0, m115}), n115, x115);
  if (|m115) n_tog = n_tog + 1;
  if (x115 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_xx_no_op                        out     1 %0d %0d %0d\n", ones({63'b0, m116}), n116, x116);
  if (|m116) n_tog = n_tog + 1;
  if (x116 != 0) n_xseen = n_xseen + 1;
  $fwrite(FH, "iu_yy_xx_cancel                    out     1 %0d %0d %0d\n", ones({63'b0, m117}), n117, x117);
  if (|m117) n_tog = n_tog + 1;
  if (x117 != 0) n_xseen = n_xseen + 1;

  $fwrite(FH, "\nSUMMARY: %0d/115 functional ports toggled (3 infrastructure ports excluded)\n", n_tog);
  $fwrite(FH, "X-SEEN : %0d functional ports held an X/Z bit at some point\n", n_xseen);
  $fwrite(FH, "NEVER TOGGLED:");
  if (~|m0) $fwrite(FH, " cp0_iu_icg_en");
  if (~|m1) $fwrite(FH, " cp0_xx_mrvbr");
  if (~|m2) $fwrite(FH, " cp0_yy_clk_en");
  if (~|m4) $fwrite(FH, " da_xx_fwd_data");
  if (~|m5) $fwrite(FH, " da_xx_fwd_dst_reg");
  if (~|m6) $fwrite(FH, " da_xx_fwd_vld");
  if (~|m8) $fwrite(FH, " hpcp_iu_cnt_en");
  if (~|m9) $fwrite(FH, " idu_alu_ex1_gateclk_sel");
  if (~|m10) $fwrite(FH, " idu_bju_ex1_gateclk_sel");
  if (~|m11) $fwrite(FH, " idu_div_ex1_gateclk_sel");
  if (~|m12) $fwrite(FH, " idu_iu_ex1_alu_dp_sel");
  if (~|m13) $fwrite(FH, " idu_iu_ex1_alu_sel");
  if (~|m14) $fwrite(FH, " idu_iu_ex1_bht_pred");
  if (~|m15) $fwrite(FH, " idu_iu_ex1_bju_br_sel");
  if (~|m16) $fwrite(FH, " idu_iu_ex1_bju_dp_sel");
  if (~|m17) $fwrite(FH, " idu_iu_ex1_bju_sel");
  if (~|m18) $fwrite(FH, " idu_iu_ex1_div_dp_sel");
  if (~|m19) $fwrite(FH, " idu_iu_ex1_div_sel");
  if (~|m20) $fwrite(FH, " idu_iu_ex1_dst0_reg");
  if (~|m21) $fwrite(FH, " idu_iu_ex1_func");
  if (~|m22) $fwrite(FH, " idu_iu_ex1_inst_vld");
  if (~|m23) $fwrite(FH, " idu_iu_ex1_length");
  if (~|m24) $fwrite(FH, " idu_iu_ex1_mult_dp_sel");
  if (~|m25) $fwrite(FH, " idu_iu_ex1_mult_sel");
  if (~|m26) $fwrite(FH, " idu_iu_ex1_pipedown_vld");
  if (~|m27) $fwrite(FH, " idu_iu_ex1_split");
  if (~|m28) $fwrite(FH, " idu_iu_ex1_src0_data");
  if (~|m29) $fwrite(FH, " idu_iu_ex1_src0_ready");
  if (~|m30) $fwrite(FH, " idu_iu_ex1_src0_reg");
  if (~|m31) $fwrite(FH, " idu_iu_ex1_src1_data");
  if (~|m32) $fwrite(FH, " idu_iu_ex1_src1_ready");
  if (~|m33) $fwrite(FH, " idu_iu_ex1_src1_reg");
  if (~|m34) $fwrite(FH, " idu_iu_ex1_src2_data");
  if (~|m35) $fwrite(FH, " idu_mult_ex1_gateclk_sel");
  if (~|m36) $fwrite(FH, " ifu_iu_chgflw_pc");
  if (~|m37) $fwrite(FH, " ifu_iu_chgflw_vld");
  if (~|m38) $fwrite(FH, " ifu_iu_ex1_pc_pred");
  if (~|m39) $fwrite(FH, " ifu_iu_reset_vld");
  if (~|m40) $fwrite(FH, " ifu_iu_warm_up");
  if (~|m41) $fwrite(FH, " lsu_iu_ex2_data");
  if (~|m42) $fwrite(FH, " lsu_iu_ex2_data_vld");
  if (~|m43) $fwrite(FH, " lsu_iu_ex2_dest_reg");
  if (~|m44) $fwrite(FH, " mmu_xx_mmu_en");
  if (~|m46) $fwrite(FH, " rtu_iu_div_wb_grant");
  if (~|m47) $fwrite(FH, " rtu_iu_div_wb_grant_for_full");
  if (~|m48) $fwrite(FH, " rtu_iu_ex1_cmplt");
  if (~|m49) $fwrite(FH, " rtu_iu_ex1_cmplt_dp");
  if (~|m50) $fwrite(FH, " rtu_iu_ex1_inst_len");
  if (~|m51) $fwrite(FH, " rtu_iu_ex1_inst_split");
  if (~|m52) $fwrite(FH, " rtu_iu_ex2_cur_pc");
  if (~|m53) $fwrite(FH, " rtu_iu_ex2_next_pc");
  if (~|m54) $fwrite(FH, " rtu_iu_mul_wb_grant");
  if (~|m55) $fwrite(FH, " rtu_iu_mul_wb_grant_for_full");
  if (~|m56) $fwrite(FH, " rtu_yy_xx_flush_fe");
  if (~|m57) $fwrite(FH, " iu_cp0_ex1_cur_pc");
  if (~|m58) $fwrite(FH, " iu_dtu_debug_info");
  if (~|m59) $fwrite(FH, " iu_hpcp_inst_bht_mispred");
  if (~|m60) $fwrite(FH, " iu_hpcp_inst_condbr");
  if (~|m61) $fwrite(FH, " iu_hpcp_jump_8m");
  if (~|m62) $fwrite(FH, " iu_idu_bju_full");
  if (~|m63) $fwrite(FH, " iu_idu_bju_global_full");
  if (~|m64) $fwrite(FH, " iu_idu_div_full");
  if (~|m65) $fwrite(FH, " iu_idu_mult_full");
  if (~|m66) $fwrite(FH, " iu_idu_mult_issue_stall");
  if (~|m67) $fwrite(FH, " iu_ifu_bht_cur_pc");
  if (~|m68) $fwrite(FH, " iu_ifu_bht_mispred");
  if (~|m69) $fwrite(FH, " iu_ifu_bht_mispred_gate");
  if (~|m70) $fwrite(FH, " iu_ifu_bht_pred");
  if (~|m71) $fwrite(FH, " iu_ifu_bht_taken");
  if (~|m72) $fwrite(FH, " iu_ifu_br_vld");
  if (~|m73) $fwrite(FH, " iu_ifu_br_vld_gate");
  if (~|m74) $fwrite(FH, " iu_ifu_link_vld");
  if (~|m75) $fwrite(FH, " iu_ifu_link_vld_gate");
  if (~|m76) $fwrite(FH, " iu_ifu_pc_mispred");
  if (~|m77) $fwrite(FH, " iu_ifu_pc_mispred_gate");
  if (~|m78) $fwrite(FH, " iu_ifu_ret_vld");
  if (~|m79) $fwrite(FH, " iu_ifu_ret_vld_gate");
  if (~|m80) $fwrite(FH, " iu_ifu_tar_pc");
  if (~|m81) $fwrite(FH, " iu_ifu_tar_pc_vld");
  if (~|m82) $fwrite(FH, " iu_ifu_tar_pc_vld_gate");
  if (~|m83) $fwrite(FH, " iu_lsu_ex1_cur_pc");
  if (~|m84) $fwrite(FH, " iu_rtu_depd_lsu_chgflow_vld");
  if (~|m85) $fwrite(FH, " iu_rtu_depd_lsu_next_pc");
  if (~|m86) $fwrite(FH, " iu_rtu_div_data");
  if (~|m87) $fwrite(FH, " iu_rtu_div_preg");
  if (~|m88) $fwrite(FH, " iu_rtu_div_wb_dp");
  if (~|m89) $fwrite(FH, " iu_rtu_div_wb_vld");
  if (~|m90) $fwrite(FH, " iu_rtu_ex1_alu_cmplt");
  if (~|m91) $fwrite(FH, " iu_rtu_ex1_alu_cmplt_dp");
  if (~|m92) $fwrite(FH, " iu_rtu_ex1_alu_data");
  if (~|m93) $fwrite(FH, " iu_rtu_ex1_alu_inst_len");
  if (~|m94) $fwrite(FH, " iu_rtu_ex1_alu_inst_split");
  if (~|m95) $fwrite(FH, " iu_rtu_ex1_alu_preg");
  if (~|m96) $fwrite(FH, " iu_rtu_ex1_alu_wb_dp");
  if (~|m97) $fwrite(FH, " iu_rtu_ex1_alu_wb_vld");
  if (~|m98) $fwrite(FH, " iu_rtu_ex1_bju_cmplt");
  if (~|m99) $fwrite(FH, " iu_rtu_ex1_bju_cmplt_dp");
  if (~|m100) $fwrite(FH, " iu_rtu_ex1_bju_data");
  if (~|m101) $fwrite(FH, " iu_rtu_ex1_bju_inst_len");
  if (~|m102) $fwrite(FH, " iu_rtu_ex1_bju_preg");
  if (~|m103) $fwrite(FH, " iu_rtu_ex1_bju_wb_dp");
  if (~|m104) $fwrite(FH, " iu_rtu_ex1_bju_wb_vld");
  if (~|m105) $fwrite(FH, " iu_rtu_ex1_branch_inst");
  if (~|m106) $fwrite(FH, " iu_rtu_ex1_cur_pc");
  if (~|m107) $fwrite(FH, " iu_rtu_ex1_div_cmplt");
  if (~|m108) $fwrite(FH, " iu_rtu_ex1_div_cmplt_dp");
  if (~|m109) $fwrite(FH, " iu_rtu_ex1_mul_cmplt");
  if (~|m110) $fwrite(FH, " iu_rtu_ex1_mul_cmplt_dp");
  if (~|m111) $fwrite(FH, " iu_rtu_ex1_next_pc");
  if (~|m112) $fwrite(FH, " iu_rtu_ex2_bju_ras_mispred");
  if (~|m113) $fwrite(FH, " iu_rtu_ex3_mul_data");
  if (~|m114) $fwrite(FH, " iu_rtu_ex3_mul_preg");
  if (~|m115) $fwrite(FH, " iu_rtu_ex3_mul_wb_vld");
  if (~|m116) $fwrite(FH, " iu_xx_no_op");
  if (~|m117) $fwrite(FH, " iu_yy_xx_cancel");
  $fwrite(FH, "\n");
  $fclose(FH);
  $display("[iu_toggle_mon] %0d/115 functional IU ports toggled; report in iu_toggle.report", n_tog);
end
